  ...
  return (
    <Link href="/" className={`${styles.cardContainer} ${cardStyles}`}>
        <div className={styles.cardFlex}>
          ...
          <span className={styles.cardContainerImg}><img className={styles.cardImg} width="200" height="200" src="https://i.pinimg.com/564x/c2/4e/5f/c24e5f780c3ef0f3a03bf7c031ef0d21.jpg" alt="dynamic placeholder" /></span>
        </div>
    </Link>
  );
};
